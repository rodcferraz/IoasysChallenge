    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            var config = new MapperConfiguration(cfg =>
            {
                ...
                cfg.CreateMap<CreateMovieViewModel, Movie>();
            });
            ...
            var key = Encoding.ASCII.GetBytes(TokenService.Token);
...
;            });
            ...
            app.UseEndpoints(endpoints =>
            {
                ...
                endpoints.MapControllerRoute(
                    name: "Default",
                    pattern: "{controller=User}/{action=Delete}"
                );
                endpoints.MapControllerRoute(
                    name: "Default",
                    pattern: "{controller=User}/{action=Vote}"
                );
                endpoints.MapControllerRoute(
                    name: "Default",
